...
| Q10 | How does apparent grain-growth activation compare with imposed microscopic barriers? | B1 recovers 0.45 eV exactly within uncertainty. Mechanism-isolation event/growth Q is 0.250122/0.143697 eV for G2, 0.266257/0.275837 eV for T2, 0.196481/0.101674 eV for S2, 0.379942/0.331391 eV for C2, and 0.220058/0.166992 eV for C3. Fully physical event/growth Q becomes 0.531786/0.500831 eV (G2), 0.582746/0.658646 eV (T2), 0.495505/0.479876 eV (S2), 0.658582/0.675428 eV (C2), and 0.522374/0.541221 eV (C3). Coarse-grained Q is emergent rather than a direct microscopic-barrier readout. |
...
| Q23 | At what temperature does the dominant difficult event cross from shear/TJ compatibility to climb/point-defect control? | C2/C3 supply isolated climb trends: their local event slopes fall 0.436→0.317 and 0.252→0.158 eV. In FP-C2, slopes instead stabilize near 0.74--0.76 eV above 900 K; the C3/FP-C3 pair reverses event curvature from 0.252→0.158 to 0.398→0.621 eV and places an exchange transition near 900 K. A coupled-process crossover still requires FP-C4/FP-C5 and FP-SC3. |
