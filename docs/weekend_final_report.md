...
| Q7 | Can climb alone generate intermittency and velocity-curvature decorrelation? | Yes. C1--C5 give CV 0.994--1.178, reverse motion 70.4--80.2%, and velocity--curvature `R²=1.6e-4`--`8.2e-4`. FP-C2 independently gives CV 0.977--1.159, reverse motion 70.33--77.65%, and `R²<=0.00205`. The decorrelation is substantial; intermittency is moderate compared with strict TJ cases. |
...
| Q10 | How does apparent grain-growth activation compare with imposed microscopic barriers? | B1 recovers 0.45 eV exactly within uncertainty. Mechanism-isolation event/growth Q is 0.250122/0.143697 eV for G2, 0.266257/0.275837 eV for T2, 0.196481/0.101674 eV for S2, and 0.379942/0.331391 eV for C2. Fully physical event/growth Q becomes 0.531786/0.500831 eV (G2), 0.582746/0.658646 eV (T2), 0.495505/0.479876 eV (S2), and 0.658582/0.675428 eV (C2). Coarse-grained Q is emergent rather than a direct microscopic-barrier readout. |
...
| Q23 | At what temperature does the dominant difficult event cross from shear/TJ compatibility to climb/point-defect control? | C2 supplies the isolated climb trend: its local growth/event slopes fall 0.375→0.242 and 0.436→0.317 eV. In FP-C2, the corresponding slopes instead stabilize near 0.74--0.76 eV above 900 K after a 0.572/0.514 eV low-temperature interval. Locating a coupled-process crossover still requires FP-C3--FP-C5 and FP-SC3. |
| Q24 | Does that crossover curve the Arrhenius plot or change the growth exponent? | C2 and FP-G2/FP-T2/FP-S2/FP-C2 all retain common `n=1` while local Arrhenius slopes change strongly. FP-C2 growth/event slopes change 0.572→0.743→0.739 and 0.514→0.746→0.761 eV, opposite C2's declining slopes; FP-S2 slopes rise 0.443→0.564 and 0.336→0.638 eV. Coupled physics curves Arrhenius behavior without changing the fitted common exponent. |
